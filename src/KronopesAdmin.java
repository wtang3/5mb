...
/*import static Admin.TableModelTest.FILE_NAME;*/
import java.io.File;
...
File ALLREQUEST_FILE = new File("DATA\\allRequest.csv");
    ...
    private void initComponents() {
        ...
        saveChangesButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Admin/Save.png"))); // NOI18N
        ...
        cancelButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Admin/cancel.png"))); // NOI18N
        ...
        modTimecardsButton.setForeground(new java.awt.Color(204, 204, 204));
        modTimecardsButton.setIcon(new javax.swing.ImageIcon("C:\\Users\\Ameenah\\Documents\\NetBeansProjects\\RMS_SE_Fall\\schedule2.png")); // NOI18N
        ...
        createScheduleButton.setBackground(new java.awt.Color(204, 204, 204));
        createScheduleButton.setForeground(new java.awt.Color(204, 204, 204));
        createScheduleButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Admin/schedule-icon (2).png"))); // NOI18N
        createScheduleButton.setText("Create Schedule");
        createScheduleButton.setContentAreaFilled(false);
        createScheduleButton.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        timeoffRequestButton.setForeground(new java.awt.Color(204, 204, 204));
        timeoffRequestButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Admin/off.png"))); // NOI18N
                ...
                .addGroup(KronopesPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(KronopesPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(KronopesPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(logo)
                            .addComponent(createScheduleButton, javax.swing.GroupLayout.PREFERRED_SIZE, 192, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        KronopesPanelLayout.setVerticalGroup(
            ...
            .addGroup(KronopesPanelLayout.createSequentialGroup()
                .addGap(50, 50, 50)
                .addGroup(KronopesPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addGroup(KronopesPanelLayout.createSequentialGroup()
                        .addGroup(KronopesPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(KronopesPanelLayout.createSequentialGroup()
                                .addGroup(KronopesPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addGroup(KronopesPanelLayout.createSequentialGroup()
                                ...
                                .addGap(30, 30, 30)
                                .addComponent(createScheduleButton)
                                .addGap(29, 29, 29)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, KronopesPanelLayout.createSequentialGroup()
                        .addGap(99, 99, 99)
    ...
    private void createScheduleButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createScheduleButtonActionPerformed
    ...
    private void modTimecardsButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modTimecardsButtonActionPerformed
        try {
            Kronopes mt = new Kronopes();
        } catch (FileNotFoundException ex) {
            Logger.getLogger(KronopesAdmin.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void findEmpButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_findEmpButtonActionPerformed
     try{
        DefaultTableModel tm = (DefaultTableModel) employeeAvailabilityTable.getModel();
            ...
            Scanner scanner1 = new Scanner(new File("1001Availability.txt"));
            int count = 0;
    ...
    private void displayAvailStaffTable() {
       ...
       try{
        ...
        Scanner scannerd = new Scanner(new File("employee.txt"));
        int count = 0;
    ...
    private void displayPossibleOTTable() {
        ...
        Scanner emp = new Scanner(new File("employee.txt"));
        Scanner pay = new Scanner(new File("pay.txt"));
        int count = 0;
    ...
    private void displayShiftManager() {
        ...
        Scanner scsm = new Scanner(new File("clockedInAdminSample.txt"));
        int count = 0;
    ...
    try {
        DefaultTableModel timeOffModel = (DefaultTableModel) torTable.getModel();
        String[] dColArray = {"empID","Start","End"};        
        Vector<String> dColNames = new Vector<>(Arrays.asList(dColArray));
        Vector<Vector<String>> dDataVector = new Vector<Vector<String>>();
        Vector<String> dRowVector = new Vector<String>();
        Scanner scannerd = new Scanner(ALLREQUEST_FILE);
        int count = 0;
        ...
        timeOffModel = new DefaultTableModel(dDataVector, dColNames);
        torTable.setModel(timeOffModel);
        
        
    } catch (FileNotFoundException ex) {
       JOptionPane.showMessageDialog(null, "ERROR: "+ALLREQUEST_FILE+" Not Found");
    }
    }  
